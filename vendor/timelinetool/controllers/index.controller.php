...
class Index {
  ...
  function __construct(&$aRequest, &$aSession, &$aCookie = '') {
    ...
    require PATH_STANDARD . '/vendor/timelinetool/controllers/main.controller.php';
    ...
    require PATH_STANDARD . '/vendor/timelinetool/helpers/session.helper.php';
    ...
    $this->getConfig();
    SessionHelper::getUserSession($aSession, $aCookie);
